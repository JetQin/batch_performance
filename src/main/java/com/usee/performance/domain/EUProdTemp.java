 ...
 */
@Entity
@Table(name = "INTF_NOVISTAR_PROD_TEMP")
@IdClass(ProdPK.class)
public @Data class EUProdTemp extends AbstractEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7549909375489638611L;
	...
	public EUProdTemp(String completionId, String completionName,
